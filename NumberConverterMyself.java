package ir.ac.kntu;
public class NumberConverterMyself   
{  
...
String[] twodigits = new String[] {"", "tTen", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"};  
